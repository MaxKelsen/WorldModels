...
CONV_KERNEL_SIZES = [4,5,4,4,4]
CONV_STRIDES = [2,2,2,2,2]
CONV_ACTIVATIONS = ['relu','relu','relu','relu','relu']
# CONV_ACTIVATIONS = ['tanh','relu','relu','relu','relu']

DENSE_SIZE = 10240

CONV_T_FILTERS = [256,128,64,32,3]
CONV_T_KERNEL_SIZES = [4,4,4,4,6]
...
class VAE():
    ...
    def _build(self):
        ...
        vae_c5 = Conv2D(filters = CONV_FILTERS[4], kernel_size = CONV_KERNEL_SIZES[4], strides = CONV_STRIDES[4], activation=CONV_ACTIVATIONS[0])(vae_c4)
        ...
        vae_dense = Dense(DENSE_SIZE)
        vae_dense_model = vae_dense(vae_z)

        # reshape to output shape of encoder
        vae_z_out = Reshape((5,8,256))
        ...
        vae_d5 = Conv2DTranspose(filters = CONV_T_FILTERS[4], kernel_size = CONV_T_KERNEL_SIZES[4] , strides = CONV_T_STRIDES[4], activation=CONV_T_ACTIVATIONS[4])
