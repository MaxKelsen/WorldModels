...
def simulate(model, train_mode=False, render_mode=True, num_episode=5, seed=-1, max_len=-1, generate_data_mode = False):
    ...
    for episode in range(num_episode):
        ...
        print ("action 1: " + str(action.shape))
        ...
        for t in range(max_episode_length):
            ...
            # print ("action 2: " + str(action))
            # round values to either 1 or 0
            action_disc = []
            for a in action:
                if (a > 0.5):
                    a = 1
                    ...
                    a = 0
                action_disc.append(a)
            
            print ("discretised: " + str(action_disc))

            obs, reward, done, info = model.env.step(action_disc)
